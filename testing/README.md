...
<img src="source/21-web_publick.png" width="700">
<img src="source/22-web_publick.png" width="700">
...
<img src="source/23-tracert_main_pc_01.png" width="700">

> Трассировка с main_pc_01 когда основной канал связи работает.

<img src="source/24-tracert_provider_test_main_pc_01.png" width="700">

> Трассировка с main_pc_01 когда основной канал связи упал.  
> Требует перезагрузки симуляции для корректной перестройки маршрутов. Вообще, по заданию, ACL на коммутаторах ядра и ASA не предполагают получение юзерами ICMP со всех адресов, для получения трассировки ACL расширены.
...
<img src="source/25-tracert_main_pc_01.png" width="700">
...
<img src="source/26-tracert_core_test_main_pc_01.png" width="700">
...
<img src="source/27-tracert_fw_test_main_pc_01.png" width="700">

> Трассировка с main_pc_01, при выключенном межсетевом экране main-asa-01. Трафик идет по пути main_core_sw_02 > main-asa-02 > main_border_01 > INTERNET.

<img src="source/28-tracert_border_test_main_pc_01.png" width="700">

> Трассировка с main_pc_01, при выключенном бордере main_border_01.
> Придется перезагружать симуляцию. Трафик идет по пути main_core_sw_01 > main_core_sw_02 > main-asa-02 > main_border_02 > INTERNET.
...
<img src="source/29-acl_main_laptop_01.png" width="700">

> Пинги с main_laptop_01, в интернет, в USERS-сеть, в MGMT-сеть.

<img src="source/30-acl_main_laptop_01.png" width="700">
...
<img src="source/31-acl_branch1_pc_01.png" width="700">

> Пинги с branch1_pc_01, доступа в интернет нет, доступ к веб серверу имеется (доступ по локальному адресу, имя резолвится с приватного DNS сервера), доступ к принтеру в главном офисе имеется.

<img src="source/32-acl_branch1_pc_01.png" width="700">

> Но для пользователей гостевого Wi-Fi в филиале сделал как в ЦО.
> Пинги с branch1_laptop_01, доступ в интернет есть, доступ к веб серверу имеется (доступ по публичному адресу, имя резолвится с публичного DNS сервера), доступ к принтеру в главном офисе отсутствует (как и ко всей приватной сети).
